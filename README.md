...
An application for keep tracker of jobs applied and what files were used to apply to those jobs. The data is stored locally on the system in the form of a sqlite database.
